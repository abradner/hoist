...
|---|---|---|---|
| TUI / CLI | `cmd/hoist` | Local user; whoever runs the binary | The only human input. Keypresses in the plan/confirm, deploy-confirm and flight screens are the authorisation for everything below. |
